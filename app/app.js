...
const app = express();
const { getProperties, postFavourite, deleteFavourite, getSingleProperty, getReviews } = require("./controllers");
...
app.route("/api/properties/:id/reviews").get(getReviews).all(handleMethodNotAllowed);
