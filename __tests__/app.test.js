...
describe("GET /api/properties?maxprice=<price_per_night> happy path", () => {
  test("should respond with a server status of 200", async () => {
...
describe("GET /api/properties?maxprice=<price_per_night> sad path", () => {
...
describe("GET /api/properties?minprice=<price_per_night> happy path", () => {
  test("should respond with a server status of 200", async () => {
...
describe("GET /api/properties?minprice=<price_per_night> sad path", () => {
  test("400 - Bad Request", async () => {
