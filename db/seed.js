...
const { dropTables, tables, insertPropertyTypes, insertUsers, usersKey, insertProperties, propertiesKey, insertFavourites, insertReviews, insertImages, insertBookings, addBookingsConstaints } = require("./manage-queries");
